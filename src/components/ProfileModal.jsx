...
const ProfileModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`absolute top-full -right-32 w-64 sm:w-96 bg-gray-950 text-white  shadow-lg transform transition-all duration-300 ease-in-out z-0 ${
    ...
    >
      <div className="flex flex-col max-h-[calc(100vh-5rem)] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b sticky top-0 bg-gray-950 z-10">
